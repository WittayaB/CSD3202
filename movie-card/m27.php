...
$sql = "SELECT title, poster, release_date, duration, rating, format, imdb_rating, synopsis FROM movies WHERE id = '27'";
...
<nav class="navbar sticky-top navbar-expand-sm navbar-light " style="background-color:  #333;" >
  <div class="container" style="background-color: #333;">
    ...
    <div class="container" >
      ...
      src="https://www.youtube.com/embed/TwXgOMDONK8?si=RZX94Sul_sO6ZOf5" allowfullscreen></iframe>
