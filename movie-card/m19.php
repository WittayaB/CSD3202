...
$sql = "SELECT title, poster, release_date, duration, rating, format, imdb_rating, synopsis FROM movies WHERE id = '19'";
...
<nav class="navbar sticky-top navbar-expand-sm navbar-light " style="background-color:  #333;" >
  <div class="container" style="background-color: #333;">
    ...
    <div class="container" >
      ...
      src="https://www.youtube.com/embed/aeQe_mZcyf8?feature=shared" allowfullscreen></iframe>
