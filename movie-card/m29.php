...
$sql = "SELECT title, poster, release_date, duration, rating, format, imdb_rating, synopsis FROM movies WHERE id = '29'";
...
<nav class="navbar sticky-top navbar-expand-sm navbar-light " style="background-color:  #333;" >
  <div class="container" style="background-color: #333;">
    ...
    <div class="container" >
      ...
      src="https://www.youtube.com/embed/87E6N7ToCxs?feature=shared" allowfullscreen></iframe>
