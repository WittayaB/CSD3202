...
<body>
    ...
    <section class="movie-list">
        <h2>วิทยาศาสตร์ Sci-fi</h2>
        <div class="container">
        <!-- ภาพแถวที่ 1 -->
            <!-- AVATAR -->
            <div class="col">
                <a href="../movie-card/m20.php"><img src="../admin/uploads/ADASTRA.jpg" alt="ADASTRA"></a>
            </div>
            <!-- AVATAR AWAY OF WATER -->
            <div class="col" style="height: 40px;">
                <a href="../movie-card/m2.php"><img src="../admin/uploads/avatar_away_of_water.jpg" alt="avatar_away_of_water"></a>
            </div>
            <!-- BLACK ADAM -->
            <div class="col">
            ...
            <!-- Avengers2 -->
            <div class="col">
                <a href="../movie-card/m15.php"><img src="../admin/uploads/Interstellar.jpg" alt="Interstellar"></a>
            </div>
