...
<body>
    ...
    <section class="movie-list">
        <h2>ผจญภัย adventure</h2>
        <div class="container">
        <!-- ภาพแถวที่ 1 -->
            <!-- AVATAR -->
            <div class="col">
                <a href="../movie-card/m2.php"><img src="../admin/uploads/avatar_away_of_water.jpg" alt="AVATAR"></a>
            </div>
            <!-- AVATAR AWAY OF WATER -->
            <div class="col" style="height: 40px;">
                <a href="../movie-card/m1.php"><img src="../admin/uploads/avatar11.jpg" alt="AVATAR AWAY OF WATER"></a>
            </div>
            <!-- BLACK ADAM -->
            <div class="col">
                <a href="../movie-card/m6.php"><img src="../admin/uploads/avengers1.jpg" alt="BLACK ADAM"></a>
            </div>
            <!-- Avengers2 -->
            <div class="col">
            ...
            <!-- AVATAR AWAY OF WATER -->
            <div class="col" style="height: 40px;">
                <a href="../movie-card/m29.php"><img src="../admin/uploads/WRECK-IT-RALPH.jpg" alt="WRECK-IT-RALPH"></a>
            </div>
             <!-- AVATAR AWAY OF WATER -->
             <div class="col" style="height: 40px;">
                <a href="../movie-card/m30.php"><img src="../admin/uploads/Wreck-It-Ralph2.jpg" alt="WRECK-IT-RALPH2"></a>
            </div>
             <!-- AVATAR AWAY OF WATER -->
             <div class="col" style="height: 40px;">
             ...
             <!-- AVATAR AWAY OF WATER -->
             <div class="col" style="height: 40px;">
                <a href="../movie-card/m23.php"><img src="../admin/uploads/toy_story.jpg" alt="toy story"></a>
            </div>
             <!-- AVATAR AWAY OF WATER -->
             <div class="col" style="height: 40px;">
                <a href="../movie-card/m24.php"><img src="../admin/uploads/Toy_Story2.jpg" alt="toy story2"></a>
            </div>
             <!-- AVATAR AWAY OF WATER -->
             <div class="col" style="height: 40px;">
                <a href="../movie-card/m25.php"><img src="../admin/uploads/Toy_Stor_3.jpg" alt="toy story3"></a>
            </div>
             <!-- AVATAR AWAY OF WATER -->
             <div class="col" style="height: 40px;">
                <a href="../movie-card/m26.php"><img src="../admin/uploads/toy_story4.jpg" alt="toy story4"></a>
            </div>
