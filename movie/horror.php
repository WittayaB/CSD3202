...
<body>
    ...
    <section class="movie-list">
        ...
        <!-- ภาพแถวที่ 1 -->
            <!-- AVATAR -->
            <div class="col">
                <a href="../movie-card/m21.php"><img src="../admin/uploads/T_YOD.jpg" alt="T_YOD"></a>
            </div>
            <!-- AVATAR AWAY OF WATER -->
            <div class="col" style="height: 40px;">
                <a href="../movie-card/m22.php"><img src="../admin/uploads/T_YOD2.jpg" alt="T_YOD2"></a>
            </div>
            <!-- BLACK ADAM -->
            <div class="col">
                <a href="../movie-card/m28.php"><img src="../admin/uploads/unnamed.jpg" alt="unnamed"></a>
            </div>
            <!-- Avengers2 -->
            <div class="col">
                <a href="../movie-card/m14.php"><img src="../admin/uploads/gooseBumps.jpg" alt="gooseBumps"></a>
            </div>
